...
const ActivityBar = () => {
  ...
  const panels: { id: PanelId; icon: React.ReactNode; title: string }[] = [
    { id: 'explorer', icon: <Files size={20} strokeWidth={1.5} />, title: t('activityBar.explorer') },
    { id: 'search', icon: <Search size={20} strokeWidth={1.5} />, title: t('activityBar.search') },
    { id: 'git', icon: <GitBranch size={20} strokeWidth={1.5} />, title: t('activityBar.sourceControl') },
    { id: 'debug', icon: <Bug size={20} strokeWidth={1.5} />, title: t('activityBar.runAndDebug') },
    { id: 'extensions', icon: <Blocks size={20} strokeWidth={1.5} />, title: t('activityBar.extensions') },
  ];
