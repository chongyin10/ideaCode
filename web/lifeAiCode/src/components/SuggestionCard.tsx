...
export function SuggestionCard({ suggestion, onAccept, onReject, onPreviewDiff }: SuggestionCardProps) {
          ...
          {suggestion.changes.map((change, idx) => (
            <div key={idx}>
              <div className="suggestion-card__file">
                ...
                {change.explanation && <span style={{ marginLeft: 8, color: 'var(--text-muted)' }}>— {change.explanation}</span>}
              </div>
