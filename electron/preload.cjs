...
const electronAPI = {
  ...
  git: {
    ...
    createBranch: (dirPath, branch) => ipcRenderer.invoke(Channels.GIT_CREATE_BRANCH, dirPath, branch),
    ...
    discard: (dirPath, file) => ipcRenderer.invoke(Channels.GIT_DISCARD, dirPath, file),
